...
export default class DirectoryManager {
    ...
    constructor() {
        ...
        this.images = {
            ...
            gameplay: ['chute', 'hp-bar', 'hp-drain', 'note-hold', 'note-receptor', 'note', 'track', 'chute-enabled'],
        }
    }
    ...
    getScenes(): string[] {
        return this.scenes.map(scene => new URL(`http://192.168.4.133:8080/assets/images/${scene}.ts`, import.meta.url).href)
    }
}